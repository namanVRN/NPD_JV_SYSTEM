...
export default function App() {
  ...
  // Track path updates for bypass navigation (Inventory)
  ...
  const renderPage = () => {
    switch (activeTab) {
      ...
      case "done":
        // ✅ Fixed DonePage by adding currentUser and onNextAction
        return <DonePage currentUser={user} onNextAction={handleNextAction} />;
